...
onEvent('server.datapack.first', e => {
	...
	e.addTFCDrinkable('tfc:vinegar', drink => {
		drink.consumeChance(1)
		drink.thirst(10)
		drink.effect('minecraft:nausea', effect => {
			effect.duration(40)
			effect.chance(0.8)
		})
	})
	...
	e.addTFCHeat(['create:framed_glass', 'create:framed_glass_pane', 'create:horizontal_framed_glass', 'create:horizontal_framed_glass_pane', 'create:tiled_glass', 'create:tiled_glass_pane', 'create:vertical_framed_glass', 'create:vertical_framed_glass_pane'], 0.3, null, null)
	e.addTFCHeat('immersiveengineering:ingot_hop_graphite', 8.6, 1544, 2059)
	e.addTFCHeat('create:brass_block', 7.145, null, null)
	e.addTFCHeat('immersiveengineering:storage_constantan', 3.08, null, null)
	...
	e.addTFCHeat([/minecraft:(?:waxed_)?(?:(?:exposed|weathered|oxidized)_)?(?:cut_)?copper$/, /minecraft:(?:waxed_)?copper_block/], 7.145, null, null)
	e.addTFCHeat('immersiveengineering:storage_electrum', 2.775, null, null)
	...
	e.addTFCHeat('minecraft:gold_block', 4.165, null, null)
	e.addTFCHeat('immersiveengineering:storage_lead', 4.225, null, null)
	...
	e.addTFCHeat('immersiveengineering:storage_nickel', 5.21, null, null)
	e.addTFCHeat('immersiveengineering:storage_silver', 5.21, null, null)
	e.addTFCHeat('immersiveengineering:storage_steel', 7.145, null, null)
	e.addTFCHeat('create:zinc_block', 11.905, null, null)
	e.addTFCHeat(/kubejs:ore\/.+_lead$/, 0.34, null, null)
	e.addTFCHeat(/minecraft:(?:waxed_)?(?:(?:exposed|weathered|oxidized)_)?(?:cut_)?copper_slab/, 3.573, null, null)
	e.addTFCHeat(['createdeco:cast_iron_block', 'minecraft:iron_block'], 7.145, null, null)
	e.addTFCHeat('tfc:powder/coke', 7.31, null, null)
	e.addTFCHeat('immersiveengineering:ingot_aluminum', 0.46, 396.18, null)
	e.addTFCHeat('immersiveengineering:wire_aluminum', 0.115, 396.18, null)
	e.addTFCHeat('immersiveengineering:stick_aluminum', 0.23, 396.18, null)
	e.addTFCHeat(['firmalife:ore/small_chromite', 'firmalife:ore/normal_chromite', 'firmalife:ore/poor_chromite', 'firmalife:ore/rich_chromite'], 1.143, 1144, 1526, 'firmalife:ore/chromite')
	e.addTFCHeat('#forge:double_ingots/chromium', 4.64, 1144, 1526, 'firmalife:metal/chromium_double_ingot')
	e.addTFCHeat('#forge:sheets/stainless_steel', 5.0533, 924, 1232, 'firmalife:metal/stainless_steel_sheet')
	e.addTFCHeat('#forge:rods/stainless_steel', 1.263, 924, 1232, 'firmalife:metal/stainless_steel_rod')
	e.addTFCHeat('#forge:ingots/stainless_steel', 2.527, 924, 1232, 'firmalife:metal/stainless_steel_ingot')
	e.addTFCHeat('#forge:double_sheets/stainless_steel', 10.107, 924, 1232, 'firmalife:metal/stainless_steel_double_sheet')
	e.addTFCHeat('#forge:double_ingots/stainless_steel', 5.0533, 924, 1232, 'firmalife:metal/stainless_steel_double_ingot')
	e.addTFCHeat('#forge:sheets/chromium', 4.64, 1144, 1526, 'firmalife:metal/chromium_sheet')
	e.addTFCHeat('#forge:rods/chromium', 1.16, 1144, 1526, 'firmalife:metal/chromium_rod')
	e.addTFCHeat('#forge:ingots/chromium', 2.32, 1144, 1526, 'firmalife:metal/chromium_ingot')
	e.addTFCHeat('#forge:double_sheets/chromium', 9.28, 1144, 1526, 'firmalife:metal/chromium_double_sheet')
	...
	e.addTFCMetal('kubejs:lead', 327, 0.00507, '#forge:ingots/lead', '#forge:sheets/lead', 0)
	e.addTFCMetal('kubejs:unrefined_graphite', 2135, 0.00728, 'tfc:powder/coke', 'kubejs:dummy', 0)
	e.addTFCMetal('firmalife:metal/chromium', 1907, 0.00696, '#forge:ingots/chromium', '#forge:sheets/chromium', 4, 'firmalife:chromium')
