...
TFCEvents.data(e => {
	...
	e.itemHeat(['#forge:rods/stainless_steel', 'firmalife:metal/block/stainless_steel_slab'], 1.263, 924, 1232, 'firmalife:metal/stainless_steel_rod');
	e.itemHeat(['#forge:ingots/stainless_steel', 'firmalife:metal/block/stainless_steel'], 2.527, 924, 1232, 'firmalife:metal/stainless_steel_ingot');
	...
	e.itemHeat(['#forge:rods/chromium', 'firmalife:metal/block/chromium_slab'], 1.16, 1144, 1526, 'firmalife:metal/chromium_rod');
	e.itemHeat(['#forge:ingots/chromium' ,'firmalife:metal/block/chromium'], 2.32, 1144, 1526, 'firmalife:metal/chromium_ingot');
	...
	e.itemHeat('firmalife:metal/block/chromium_stairs', 1.74, null, null);
	e.itemHeat('firmalife:metal/block/stainless_steel_stair', 1.895, null, null);
...
ServerEvents.highPriorityData(e => {
	...
	e.addJson('exposure:lenses/tfc_lens', {
		item: {
			item: 'tfc:lens'
		},
		focal_range: {
