...
let ids = [
	...
	/immersiveengineering:crafting.*sheetmetal.*/,
	'immersiveengineering:crafting/hempcrete',
	...
	/immersiveengineering:smelting\/.*ingot.*/,
	'immersiveengineering:bottling/sponge',
	'minecraft:brick',
	/immersiveengineering:metalpress\/.*/,
	/immersiveengineering:mineral\/.*/,
	...
	/create:crushing\/tuff(?:_recycling)?/,
...
onEvent('recipes', e => {
	e.remove({output: [
		...
		/immersiveposts:(?:fence|stick)_(?:iron|gold|copper|silver|nickel|constantan|electrum)/,
		...
		/immersiveengineering:armor_steel_.*/,
		/create:.*_sheet/,
		...
		/create:crushed_.*/,
		/immersiveengineering:connector_.*/,
