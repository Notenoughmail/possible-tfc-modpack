...
let outputs = ['immersiveengineering:conveyor_basic', 'immersiveengineering:steel_fence', 'immersiveposts:postbase', 
	...
	'immersiveengineering:wirecoil_structure_rope', 'immersiveengineering:light_engineering',
	...
	'railways:conductor_whistle', 'createaddition:modular_accumulator', /(?:create|minecraft):waxed_.+/,
...
let ids = ['immersiveengineering:mixer/concrete', 'immersiveengineering:crafting/concrete', 
	...
	'create:crafting/kinetics/speedometer', 'create:milling/calcite', /create:crushing\/tuff(_recycling)?/,
