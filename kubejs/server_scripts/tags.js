...
onEvent('tags.items', e => {
	...
	e.add('kubejs:non_tfc_minecarts', 'immersiveengineering:minecart_woodencrate')
	e.add('kubejs:non_tfc_minecarts', 'immersiveengineering:minecart_reinforcedcrate')
	e.add('kubejs:non_tfc_minecarts', 'immersiveengineering:minecart_woodenbarrel')
	e.add('kubejs:non_tfc_minecarts', 'immersiveengineering:minecart_metalbarrel')
	e.add('kubejs:non_tfc_minecarts', 'minecraft:minecart')
	e.add('kubejs:non_tfc_minecarts', 'minecraft:furnace_minecart')
	e.add('kubejs:non_tfc_minecarts', 'minecraft:tnt_minecart')
	e.add('kubejs:non_tfc_minecarts', 'minecraft:hopper_minecart')
})
