...
JEIEvents.hideItems(e => {
	...
	e.hide(/minecraft:.*(?:log|wood|planks|stem|hyphae|purpur|nether|sapling|leaves|sign|fence|prismarine|mud|sandstone|sculk|coral|end_stone|copper|(?:oak|spruce|birch|jungle|acacia|dark_oak|mangrove|cherry|bamboo|bamboo_mosaic|crimson|warped)_(?:stairs|slab|door|button|trapdoor|pressure_plate)|basalt).*/)
	e.hide(/.*netherite.*/)
