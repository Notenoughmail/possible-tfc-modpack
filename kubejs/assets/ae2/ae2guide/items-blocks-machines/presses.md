...
<Row>
  ...
  <ItemImage id="megacells:accumulation_processor_press" scale="4" />
</Row>
...
The Logic, Calculation, Engineering, and Accumulation presses are used in the production of [processors](processors.md).
These 4 presses are obtained by using a <ItemLink id="certus_quartz_cutting_knife" /> on a steel sheet.
...
<Column>
  ...
  <Row>
    ...
    <RecipeFor id="megacells:accumulation_processor_press" />
  </Row>
</Column>
...
To craft, right click the <ItemLink id="certus_quartz_cutting_knife" />
and insert an ingot of steel or wrought iron, you will then have to type the name you
